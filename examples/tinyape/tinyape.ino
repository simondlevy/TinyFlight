        ...
        bool & gotFailsafe) 
{
    ...
    if (_sbus.Read()) {
        ...
        channels.c1 = _sbus.data().ch[0] * scale + bias;
        channels.c2 = _sbus.data().ch[1] * scale + bias;
        channels.c3 = _sbus.data().ch[2] * scale + bias;
        channels.c4 = _sbus.data().ch[3] * scale + bias;
        channels.c5 = _sbus.data().ch[4] * scale + bias;
        channels.c6 = _sbus.data().ch[5] * scale + bias; 
    }
